...
-- =============================================================
-- Venda de qualquer coisa fora de eventos (livro, material etc.):
-- o admin escolhe o aluno, descreve o item e o valor; o sistema
...
create index if not exists cobrancas_avulsas_aluno_idx
  on public.cobrancas_avulsas(aluno_id);
