-- =============================================================
-- ESCOLA AMADEUS — Schema inicial de eventos
-- =============================================================
-- Como rodar:
...
create index if not exists inscricoes_aluno_idx      on public.inscricoes(aluno_id);
...
-- ---------- ALUNOS (existente) ----------
-- A tabela 'alunos' já existe. Aqui apenas garantimos RLS habilitado + política
-- de leitura pública (compatível com o fluxo atual de busca pelos pais).
-- Se preferir endurecer no futuro, troque por busca server-side via service role.
