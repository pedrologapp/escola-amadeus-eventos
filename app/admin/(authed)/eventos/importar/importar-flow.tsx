...
DIA DAS MÃES 2026
A Escola Amadeus convida todas as mães para uma tarde especial no dia 16/05/2026 (sábado), às 15h, no Novo Auditório.

Valores:
- Senha de Mãe: R$ 80,00
- Senha Extra: R$ 40,00
    ...
    <div className="space-y-6">
      ...
      <EventoForm
        initial={{
          ...
          series_permitidas: dados.series_permitidas,
          turmas_permitidas: dados.turmas_permitidas,
